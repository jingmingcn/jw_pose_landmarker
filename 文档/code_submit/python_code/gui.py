...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1048, 37))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "面部表型特征提取系统---山东省精神卫生中心"))
        ...
        self.processed_name_lbl.setText(_translate("MainWindow", "面部特征"))
        self.label_3.setText(_translate("MainWindow", "标记图像"))
        self.label_2.setText(_translate("MainWindow", "情绪识别"))
        ...
        self.startButton.setText(_translate("MainWindow", "开始提取"))
        self.endButton.setText(_translate("MainWindow", "结束提取"))
        ...
        self.action12.setText(_translate("MainWindow", "设置视频与音频设备"))
        self.actionse.setText(_translate("MainWindow", "设置文件保存路径"))
