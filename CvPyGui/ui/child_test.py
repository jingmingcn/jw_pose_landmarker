...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "音视频设备设置"))
        self.tab1_label.setText(_translate("Form", "TextLabel"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Form", "视频源"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("Form", "音频源"))
