...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.original_frame_lbl.setMinimumSize(QtCore.QSize(400, 240))
        ...
        self.processed_frame_lbl.setMinimumSize(QtCore.QSize(400, 240))
        ...
        self.eye_lbl.setMinimumSize(QtCore.QSize(400, 240))
        ...
        self.voice_lbl.setMinimumSize(QtCore.QSize(400, 240))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "肢体表型特征采集系统---山东省精神卫生中心"))
        self.original_name_lbl.setText(_translate("MainWindow", "原始图像"))
        self.processed_name_lbl.setText(_translate("MainWindow", "肢体特征"))
        self.label_3.setText(_translate("MainWindow", "标记图像"))
        self.label_2.setText(_translate("MainWindow", "肢体轮廓"))
        self.initButton.setText(_translate("MainWindow", "检测视频设备"))
        self.pushButton.setText(_translate("MainWindow", "停用视频设备"))
        self.label.setText(_translate("MainWindow", "样本编号："))
        self.startButton.setText(_translate("MainWindow", "开始录制"))
        self.endButton.setText(_translate("MainWindow", "结束录制"))
        self.shotButton.setText(_translate("MainWindow", "进程中止"))
        ...
        self.action12.setText(_translate("MainWindow", "设备选择"))
        self.actionse.setText(_translate("MainWindow", "文件设置"))
